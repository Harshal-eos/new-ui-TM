...
const Calculator = () => {
    ...
    return (
        <>
            <style jsx>{`
                .slider-custom [data-radix-slider-track] {
                    background-color: #E5E7EB !important;
                }
                .slider-custom [data-radix-slider-range] {
                    background-color: #7826F2 !important;
                }
                .slider-custom [data-radix-slider-thumb] {
                    background-color: #7826F2 !important;
                    border-color: #7826F2 !important;
                }
            `}</style>
            <div className="calculator w-full max-w-4xl mx-auto p-4 sm:p-6 md:p-8 lg:p-10 bg-white rounded-lg shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.10)] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.10)] outline outline-1 outline-offset-[-1px] outline-slate-100 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-10 overflow-hidden">
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-3">
                        ...
                        <div className="self-stretch flex gap-3 items-end">
                            <input
                                ...
                                className="flex-1 h-10 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-[#7826F2] focus:border-[#7826F2] focus:border-transparent"
                                placeholder="€3,600"
                                style={{ padding: '10px' }}
                            />
                            <Button
                ...
                <div className="w-full lg:w-80 self-stretch relative bg-slate-100 rounded-lg outline outline-1 outline-offset-[-1px] outline-slate-100 flex flex-col justify-start items-start overflow-hidden">
                    {/* TravelMoney Result */}
                    <div className="self-stretch flex-1 px-6 py-8 lg:px-10 lg:py-10 relative bg-cyan-50 flex flex-col justify-center items-start">
                        ...
                        <div className="self-stretch text-center justify-start text-blue-700 text-3xl sm:text-4xl lg:text-5xl font-medium font-['Geist'] leading-tight">
                    ...
                    {/* Competitor Result */}
                    <div className="self-stretch px-6 py-8 lg:px-10 lg:py-10 bg-white flex flex-col justify-center items-center overflow-hidden">
                        <div className="w-full text-center justify-center text-slate-900 text-sm font-light font-['Geist'] leading-tight">
                            Your refund with other apps
                        </div>
                        <div className="w-full text-center justify-center text-black text-2xl sm:text-3xl lg:text-4xl font-medium font-['Geist'] leading-tight">
                            {formatCurrency(competitorRefund)}
                        </div>
                        <div className="w-full text-center justify-center text-slate-500 text-sm font-light font-['Geist'] leading-tight">
                            ~Weeks, often months
                        </div>
                    </div>

                    {/* VS Divider */}
                    <div className="w-6 h-6 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 absolute bg-white rounded-full flex flex-col justify-center items-center overflow-hidden shadow-lg">
