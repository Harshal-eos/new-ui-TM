...
const Frame36_Step1 = () => (
    <div className="flex flex-col gap-1.5 w-[404px]" data-frame="Frame 36">
...
const Frame37_Step2 = () => (
    <div className="flex flex-col gap-2 w-[404px]" data-frame="Frame 37">
...
const Frame38_Step3 = () => (
    <div className="flex flex-col gap-2 w-[404px]" data-frame="Frame 38">
...
const Frame32_StepsContainer = () => (
    <div className="flex gap-6 w-[1260px]" data-frame="Frame 32">
        <Frame36_Step1 />
        <Frame37_Step2 />
        <Frame38_Step3 />
    </div>
...
const Frame23_Illustration = () => (
    <div className="w-[1260px] h-[733px] bg-primary-100 rounded-lg relative overflow-hidden" data-frame="Frame 23">
        {/* Background Gradient */}
        <div
...
const Frame35_StepsLayout = () => (
    <div className="flex flex-col gap-6" data-frame="Frame 35">
        <Frame32_StepsContainer />
        <div className="w-[404px] h-2 bg-gray-50 rounded-full" data-frame="Frame 32" />
